...
class OnMessage(commands.Cog, name='On Message Listeners and Events'):
    ...
    async def on_message(self, message:discord.Message):
        ...
        message.channel.send(f'{message.author.mention} Your ticket has been submitted, if you did not receive a DM from Marvin, let a staff member know. Please submit tickets and reports in a direct message with {self.client.user.mention} from now on.'),       # 
